...
is
'Admin/Dispatcher BIOEXIS monthly trailer report. Completed trips belong to Europe/Sofia completion month. Kilometres are reported per completed segment. Real loaded cargo is counted exactly once per trip.';
