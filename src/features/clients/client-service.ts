...
createClientCompany(
    ...
    if (error) {
        throw rpcError(
            error.message,
            "Фирмата не можа да бъде създадена."
        );
    }
    ...
    if (
        ...
        throw new Error(
            "Фирмата беше създадена, но липсва нейният идентификатор."
        );
    }
...
createClientSite(
    ...
    if (error) {
        throw rpcError(
            error.message,
            "Обектът не можа да бъде създаден."
        );
    }
    ...
    if (
        ...
        throw new Error(
            "Обектът беше създаден, но липсва неговият идентификатор."
        );
    }
    ...
    if (error) {
        throw new Error(
            await functionErrorMessage(
                error,
                "Клиентският акаунт не можа да бъде създаден."
            )
        );
    }
